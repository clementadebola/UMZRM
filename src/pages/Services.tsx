...
const Services = () => {
  const weeklyServices = [
    { name: 'Sunday Worship Service', time: '10:00 AM', icon: <FaChurch />, description: 'Join us for a spirit-filled worship experience every Sunday morning.' },
    { name: 'Tuesday Bible Study', time: '7:00 PM', icon: <FaBook />, description: 'Dive deep into God\'s Word with our midweek Bible study sessions.' },
    { name: 'Friday Prayer Meeting', time: '7:00 PM', icon: <FaPray />, description: 'Come together for a powerful time of corporate prayer and intercession.' },
  ];

  const monthlyPrograms = [
    'First Saturday - Combine Deliverance Sunday',
    'Third Saturday - Youth Night',
    'Last Friday - Deliverance Vigil',
  ];
